...
//                Serial.print("Unknown error,\t"); 
 ...
 // DISPLAT DATA
  ...
  add_to_tx_buf((char*) buf, &temp);
  Reading humidity = {"humidity", DHT.humidity, millis()};
...
void send_data(char* datas){
  char * data = "1,2.5,2015-8-10 16:46:13";
...
//      www.fastrprint(F("POST /readings HTTP/1.1\r\nHost: satoyamacloud.com\r\nContent-Length: 205"));
      ...
      delay(10);
//      char * data = "1,2.5,2015-8-10 16:46:13";
//      char* data = "11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111";
